...
class WordleEnv:
    ...
    def __init__(self, words: list, answers: list, test_answers: list=None, include_rem: bool=True):
        self.words = words
    ...
    def get_valid_mask(self) -> np.ndarray:
        ...
        if not self.guesses_made:
            ...
            return self._mask_cache
        mask = np.array([is_consistent(w, self.guesses_made, self.feedback_history) for w in self.words], dtype=bool)
